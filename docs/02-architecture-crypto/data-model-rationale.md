...
They match the actor model already established in the governance baseline and support the access-separation discussion in the report.
...
- the class diagram rationale in the architecture section
