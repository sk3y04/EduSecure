...
Use this file as the **live execution log** when you run the security-review scenarios for real.

This document sits between:
- the reusable structure in `docs/04-evidence-testing/testing-support/test-evidence-collection-template.md`
- the sample records in `docs/04-evidence-testing/testing-support/test-evidence-worked-examples.md`
...
4. if a scenario is important enough for the report appendix, expand it into a full record using `docs/04-evidence-testing/testing-support/test-evidence-collection-template.md`
...
| CSRF-01 | Browser/config | hostile origin + victim session | cross-site unsafe request |  | blocked / ineffective |  |  |  | No |  | Section 8 / appendix | see `docs/04-evidence-testing/testing-support/csrf-browser-evidence-capture-note.md` and the `CSRF-01` worked example |
...
| AUTH-15 | Browser victim | CSRF-like state change attempt | browser/deployment dependent |  |  |  | see `docs/04-evidence-testing/testing-support/csrf-browser-evidence-capture-note.md` |
...
| CSRF-01 | hostile-origin unsafe request | browser/session posture prevents abuse |  |  |  | use `docs/04-evidence-testing/testing-support/csrf-browser-evidence-capture-note.md` and `docs/04-evidence-testing/testing-support/test-evidence-worked-examples.md` |
