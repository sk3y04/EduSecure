...
- `docs/04-evidence-testing/testing-support/test-evidence-worked-examples.md`

Primary manual/security-review artefacts:
- `docs/05-security-review/README.md`
- `docs/05-security-review/security-sensitive-modules-inventory.md`
- `docs/05-security-review/security-test-scenarios-matrix.md`
- `docs/05-security-review/security-test-gaps-and-next-tests.md`
- `docs/05-security-review/manual-security-testing-playbook.md`
- `docs/05-security-review/postman/README.md`
- `docs/05-security-review/postman/EduSecure-Pack-11.postman_collection.json`
...
That is where the consolidated manual-security artefacts matter.
...
## 3.1 `docs/05-security-review/security-sensitive-modules-inventory.md`
...
## 3.2 `docs/05-security-review/security-test-scenarios-matrix.md`

### What it covers
This is the consolidated security-review master scenario list.
...
## 3.3 `docs/05-security-review/security-test-gaps-and-next-tests.md`
...
## 3.4 `docs/05-security-review/manual-security-testing-playbook.md`
...
For a narrower testing-support note focused specifically on how to package CSRF browser findings for the report, use `docs/04-evidence-testing/testing-support/csrf-browser-evidence-capture-note.md` alongside this broader security-review procedural playbook.

## 3.5 `docs/05-security-review/postman/README.md` and the security-review Postman bundle

### What it covers
The security-review Postman bundle provides a human-run API-client structure for the API-executable portion of the security review.
...
Taken together, these security-review artefacts cover these areas strongly:
...
- a reusable evidence recording template in `docs/04-evidence-testing/testing-support/test-evidence-collection-template.md`
...
In other words, the security-review section currently provides:
...
These manual-security artefacts provide the repository's **assurance layer beyond automation**.
