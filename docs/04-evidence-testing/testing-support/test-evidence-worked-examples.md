...
This document provides **worked sample records** showing how to fill in `docs/04-evidence-testing/testing-support/test-evidence-collection-template.md`.

Important scope note:
- these are **example writeups** based on the implemented security-review scenario design and the repository's current evidenced behavior
...
## C. Actor and target
- Actor identity/email: `student-b+security-review@example.com`
- Actor role: `STUDENT`
...
## C. Actor and target
- Actor identity/email: `mfa-student+security-review@example.com`
- Actor role: `STUDENT`
