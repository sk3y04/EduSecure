...
For a report-focused CSRF evidence checklist and wording guidance, pair this mini-template with `docs/04-evidence-testing/testing-support/csrf-browser-evidence-capture-note.md`.
