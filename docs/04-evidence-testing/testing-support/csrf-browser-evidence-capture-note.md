...
Primary scenarios:
- `CSRF-01` from `docs/05-security-review/security-test-scenarios-matrix.md`
- `AUTH-15` from `docs/05-security-review/security-test-scenarios-matrix.md`
...
If you want an appendix-ready example to copy from immediately, use the `CSRF-01` worked record in `docs/04-evidence-testing/testing-support/test-evidence-worked-examples.md`.
...
Use this note when you want one concise testing-support artefact that explains:
