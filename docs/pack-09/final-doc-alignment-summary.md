...
| Submission signing-key stability | earlier code used a fresh runtime-generated demo signing keypair | the signing model now uses a stable configured demo ECC keypair loaded from externalisable resource locations, while remaining a bounded study-project simulation |
