...
- `docs/pack-03/data-model-rationale.md`
...
This aligns with the risk logic already documented in `docs/pack-02/risk-register-refined.md`, especially:
...
This separation directly supports the secret-exposure reasoning in `docs/pack-02/risk-register-refined.md`.
