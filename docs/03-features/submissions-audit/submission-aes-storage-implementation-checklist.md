...
File:
- superseded by the later multipart upload contract documented in `docs/03-features/submissions-audit/api-submission-contract.md`
...
- `docs/99-archive/deprecated-aes-demo/aes-demo-phase-status-and-evidence.md` if the demo/real-use-case distinction needs refreshed wording
