...
Now that the feature exists in code, the implementation-aligned companion is recorded in `docs/04-evidence-testing/submissions-audit/submission-content-protection-and-retrieval.md`.
