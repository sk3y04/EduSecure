...
- treat the older JSON request-DTO assumption in this planning note as superseded by the implemented submissions evidence and testing-support evidence set
