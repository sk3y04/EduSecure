...
For the currently implemented metadata/content split and AES-at-rest boundary, see `docs/04-evidence-testing/submissions-audit/submission-content-protection-and-retrieval.md`.
