...
<template>
  <section class="surface-panel-muted p-4">
    <div class="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
      <div>
        <p class="text-sm font-semibold text-[var(--color-heading)]">Latest submission</p>
      </div>
        ...
        <div class="space-y-3">
          <div>
            ...
            <div class="mt-2 flex flex-wrap items-center gap-3">
              ...
              <span class="text-sm text-[var(--color-text-soft)]">{{ props.submission.verificationMessage }}</span>
            </div>
          </div>
          <div class="pt-1">
            <RouterLink
